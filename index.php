...
<html lang="zxx">
<head>
<title>Welcome to Valley View Academy Kitale</title>
<!-- Meta tag Keywords -->
...
<div class="main_section_agile" id="home">
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
			...
			<h1><a class="navbar-brand" href="index.html"><i class="fa fa-leanpub" aria-hidden="true"></i></a></h1>
			...
			<div class="w3layouts_header_right">
			   ...
			   <ul class="agile_forms">
				<li><a class="active" href="students/index.php"><i class="fa fa-sign-in" aria-hidden="true"></i> Sign In Student</a> </li>
				<!--<li><a class="active" href="Teacher/index.php"><i class="fa fa-sign-in" aria-hidden="true"></i> Sign In TEACHER</a> </li>
				<li><a class="active" href="meadmin/index.php"><i class="fa fa-sign-in" aria-hidden="true"></i> Sign In ADMIN</a> </li>
			...
			<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
				<nav class="link-effect-2" id="link-effect-2">
					<ul class="nav navbar-nav">
						...
						<!--<li><a href="#mail" class="effect-3 scroll">Staff</a></li>-->
						<li><a href="Teacher/index.php" class="effect-3 scroll">Staff</a></li>
						<li><a href="students/index.php" class="effect-3 scroll">Admin</a></li>
						<!--<li><a href="students/index.php" class="effect-3 scroll">Staff & Student Portal</a></li>-->
					</ul>
				</nav>
...
<div class="about-bottom">
	<div class="col-md-6 w3l_about_bottom_left">
		<div class="video-grid-single-page-agileits">
			<div data-video="E91gAjunqOM" id="video"> <img src="images/v2.jpg" alt="" class="img-responsive" /> </div>
		</div>
	...
	<div class="container">
		...
		<div class="col-md-7 wthree-services-bottom-grids">
			...
			<div class="wthree-services-right">
				<img src="images/vvs.jpg" alt="">
			</div>
			<div class="clearfix"> </div>
		</div>
		<div class="col-md-5 wthree-about-grids">
			<h4>Welcome to Our School. Home of Exellence</h4>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<p>The diversification and expansion of the School through adoption of new and topically relevant courses has led to further enhancement of our infrastructure in order to fulfill our growing needs.Computers have taken over a major part of human activities and enabled people to have more leisure by reducing his work-load. Computer Education is started from the primary classes and is one of the optional subjects in the Senior Secondary classes.Training of Vocal as well as instrumental music is provided according to the taste and interest of the students from Std. I to XII. 'Indian classical' and 'western dance' are taught in the school by experts to train, guide and help those students interested in this form of art.The school has a well equipped laboratory of Physics, Chemistry, Biology, Computer Science, Maths and Social Studies for the students to experiment and learn because learning by doing makes concrete concept formation. </p>
			</div> 
		</div>
	</div>
</div>
	...
	<div class="container">
		<div class="stats-info">
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				...
				<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='5' data-delay='.5' data-increment="1">12760</div>
				
				<h4 class="stats-info">FOREIGN FOLLOWERS</h4>
			</div>
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				<i class="fa fa-book" aria-hidden="true"></i>
				<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='11' data-delay='.5' data-increment="1">31000</div>
				
				<h4 class="stats-info">CLASSES COMPLETE</h4>
			</div>
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				<i class="fa fa-trophy" aria-hidden="true"></i>
				<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='500' data-delay='.5' data-increment="10">79000</div>
				
				<h4 class="stats-info">STUDENTS ENROLLED</h4>
			</div>
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
					<i class="fa fa-user" aria-hidden="true"></i>
				<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='25' data-delay='.5' data-increment="1">600</div>
	...
	<div class="container">  
		...
		<div class="services-w3ls-row">
			<div class="col-xs-4 services-grid agileits-w3layouts">
				...
				<p>As valley view Academy-Kitale Community, We offer Scholarship to very needy children in our community at large. Since we are here to educate pupils in our community, We also provide School waiver at sometimes.</p>
			</div>
			<div class="col-xs-4 services-grid agileits-w3layouts">
				<h6>02</h6>
				<h5>Skilled Teachers </h5>
				<p>Valley view Academy-Kitale has enough number of qualified teachers who are highly Skilled</p>
			...
			<div class="col-xs-4 services-grid agileits-w3layouts">
				...
				<p>Valley View Academy-Kitale is a very fast growing private institution in Trans-Nzoia County. We are aiming to build a library that will serve the community pupils at large.</p>
			</div> 
			<div class="clearfix"> </div>
		</div>  
	</div>
	...
	<div class="container">
		...
		<div class="team-w3l-grid">
			<div class="col-md-4 col-xs-4 about-poleft t1">
				<div class="about_img"><img src="images/buluma.jpg" alt="">
				  <h5>MR. PHANIX BULUMA</h5>
				  <div class="about_opa">
					<p>HEADTEACHER</p>
			...
			<div class="col-md-4 col-xs-4 about-poleft t3">
				<div class="about_img"><img src="images/buluma.jpg" alt="">
				  <h5>MR. STEPHIN MALALA</h5>
				  <div class="about_opa">
					<p>SOCIAL STUDIES HEAD OF DEPARTMENT</p>
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="#"></a></li>
						<li><a class="fa fa-twitter" href="#"></a></li>
						<li><a class="fa fa-google" href="#"></a></li>
		...
		<div class="team-w3l-grid grid-2-team">
			<div class="col-md-4 col-xs-4 about-poleft t1">
				<div class="about_img"><img src="images/buluma.jpg" alt="">
				  <h5>MRS. VIOLA CHEROTICH</h5>
				  <div class="about_opa">
					<p>KISWAHILI HEAD OF DEPARTMENT</p>
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="#"></a></li>
						<li><a class="fa fa-twitter" href="#"></a></li>
						<li><a class="fa fa-google" href="#"></a></li>
			...
			<div class="col-md-4 col-xs-4 about-poleft t2">
				<div class="about_img"><img src="images/buluma.jpg" alt="">
				  <h5>WYCLIFF WAFULA</h5>
				  <div class="about_opa">
					<p>2021 CLASS EIGHT TEACHER IN-CHARGE</p>
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="#"></a></li>
						<li><a class="fa fa-twitter" href="#"></a></li>
						<li><a class="fa fa-google" href="#"></a></li>
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>© <?php echo $general_fetch['website_start']; ?> <p>CopyRight &copy 2021. Valley View Academy-Kitale. All Rights Reserved | Design and Develop By Tonny Kiptanui</p>
	</div>
</div>
	<!-- //footer -->
...
<!-- Map-JavaScript -->
			...
			<script type="text/javascript">
				...
				function init() {
					var mapOptions = {
						zoom: 11,
						center: new google.maps.LatLng(1.1016401,35.0707968),
					...
					var marker = new google.maps.Marker({
						position: new google.maps.LatLng(1.1016401,35.0707968),
						map: map,
					});
				}
			</script>
