...
<body>
	<div class="page-container">
		...
		<div class="sidebar-menu">
			<header class="logo">
				<a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="index.html"> <span id="logo"> <h1>VALLEY VIEW</h1></span> 
			...
			<div class="menu">
				<ul id="menu">
					...
					<ul id="menu-academico-sub">
							...
							<li id="menu-academico-avaliacoes"><a href="class-information.php?ravi=teacher-delete">Class Information</a></li>
					...
					<li><a href="#"><i class="fa fa-table"></i> <span>Salary</span>
						<span class="fa fa-angle-right" style="float: right"></span></a>
						<ul id="menu-academico-sub">
							<li id="menu-academico-avaliacoes"><a href="select.php">Salary Information</a></li>
							<li id="menu-academico-boletim"><a href="teacher-salary.html">New Salary</a></li>
							<li id="menu-academico-avaliacoes"><a href="#">Deductions</a></li>
						</ul>
					</li>
					<li id="menu-academico"><a href="#"><i class="fa fa-file-text-o"></i> <span>Finance</span> <span class="fa fa-angle-right" style="float: right"></span></a>
						<ul id="menu-academico-sub">
							<li id="menu-academico-avaliacoes"><a href="fee/login.php?ravi=general-information">Student Finance</a></li>
							<li id="menu-academico-avaliacoes"><a href="add-table.php?ravi=add-table">Teacher salary</a></li>
							<li id="menu-academico-avaliacoes"><a href="home.php?ravi=general-information">Expenditure</a></li>
						</ul>
					</li>
