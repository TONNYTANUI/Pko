    ...
    <div class="login-area">
        <div class="container">
            ...
            <form action="login.php" class="login-form" method="POST">
                ...
                <input type="text" class="input-username" name="username" placeholder="Enter Username" value="<?php
                ...
                <input type="password" class="input-password" name="password" placeholder="Enter Password" value="<?php
