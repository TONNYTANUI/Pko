		...
		<li><a href="#section-3" class="icon-food"><i class="fa fa-cutlery"></i> <span>My Students</span></a></li>
		<li><a href="#section-4" class="icon-lab"><i class="fa fa-flask"></i> <span>Subject</span></a></li>
		<li><a href="#section-5" class="icon-truck"><i class="fa fa-truck"></i> <span>Change Teacher Info</span></a></li>
		</ul>
		</nav>
			...
			<div class="form-body text-center">
				<form class="form-horizontal text-center" method="post">
					...
					<div class="text-center"> 
						<input type="submit" class="btn btn-default" name="update_t_info" value ="Update Teacher Info">
						</div>
				</form>
			</div>
		...
		<?php 
	if(isset($_POST['update_t_info'])){
		$new_username = $_POST['new_username'];
		$current_username = $_POST['current_username'];
		$current_password = $_POST['current_password'];
		$new_password = $_POST['new_password'];
		$checkmatch = $ravi->t_check($current_username,$current_password);
		if($checkmatch){
			$success = $ravi->t_updatepassword($new_password,$new_username);
			if($success){
